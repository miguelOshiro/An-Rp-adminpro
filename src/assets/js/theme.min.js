...
const customInitFunctions = () => {
    ...
    "use strict";
    $.extend({ HSCore: { init: function() { $(document).ready((function() { $('[data-toggle="tooltip"]').tooltip(), $('[data-toggle="popover"]').popover() })) }, components: {} } }), $.HSCore.init(),
        function(t) {
                ...
                init: function(e, s) {
                    if (e.length) {
                        var a = Object.assign({}, this.defaults),
                            ...
                            i = {};
                        i = t.extend(!0, n.type, a, "line" === n.type ? {
                            options: {
                                scales: {
                                    yAxes: [{
                                        ticks: {
                                ...
                                tooltips: {
                                    custom: function(t) {
                                        ...
                                        if (s.classList.remove("above", "below", "no-transform"), t.yAlign ? s.classList.add(t.yAlign) : s.classList.add("no-transform"), t.body) {
                                            ...
                                            a.forEach((function(t) { r += i.options.tooltips.yearStamp ? t + ", " + o.getFullYear() : t })), r += '</header><div class="hs-chartjs-tooltip-body">', n.forEach((function(e, s) {
                                                r += "<div>";
                                                var a = e[0],
                                                    n = a,
                                                    o = t.labelColors[s].backgroundColor instanceof Object ? t.labelColors[s].borderColor : t.labelColors[s].backgroundColor;
                                                r += (i.options.tooltips.hasIndicator ? '<span class="d-inline-block rounded-circle mr-1" style="width: ' + i.options.tooltips.indicatorWidth + "; height: " + i.options.tooltips.indicatorHeight + "; background-color: " + o + '"></span>' : "") + i.options.tooltips.prefix + (a.length > 3 ? n : e) + i.options.tooltips.postfix, r += "</div>"
                                            })), r += "</div>", s.querySelector(".hs-chartjs-tooltip").innerHTML = r
                                        }
                                        var l = this._chart.canvas.getBoundingClientRect();
                                        s.style.opacity = 1, i.options.tooltips.lineMode ? s.style.left = t.caretX + "px" : s.style.left = l.left + window.pageXOffset + t.caretX - s.offsetWidth / 2 - 3 + "px", s.style.top = l.top + window.pageYOffset + t.caretY - s.offsetHeight - 25 + "px", s.style.pointerEvents = "none", s.style.transition = i.options.tooltips.transition
                                    }
                                }
                            }
                        }, n, i, s)).type && i.data.datasets.forEach((function(t) {
                        ...
                        if ("line" === i.type && i.options.tooltips.lineMode) {
                            ...
                            }, e.on("mouseleave", (function() { t("#lineTooltipChartJSStyles").attr("media", "max-width: 1px") })), e.on("mouseenter", (function() { t("#lineTooltipChartJSStyles").removeAttr("media") })), e.on("mousemove", (function(s) { s.pageY - e.offset().top > t(".hs-chartjs-tooltip-wrap").height() / 2 && s.pageY - e.offset().top + t(".hs-chartjs-tooltip-wrap").outerHeight() / 2 < e.height() && t(".hs-chartjs-tooltip").css({ top: s.pageY + t(".hs-chartjs-tooltip-wrap").height() / 2 - (e.offset().top + e.height() / 2) }) }))
                        }
                        return o
                    }
                }
        ...
        function(t) {
            t.HSCore.components.HSCircles = {
                ...
                setId: function(t, e) { t.attr("id", e) },
                ...
                setRtl: function(t) { t.find("svg").css("transform", "matrix(-1, 0, 0, 1, 0, 0)") },
                ...
                initAppear: function(e, s) {
                    var a = s;
                    appear({ bounds: a.bounds, debounce: a.debounce, elements: function() { return document.querySelectorAll("#" + a.id) }, appear: function(s) { e.update(JSON.parse(t(s).attr("data-hs-circles-options")).value) } })
                }
            }
        }(jQuery),
        function(t) {
                ...
                init: function(e, s) {
                    if (t(e).length) {
                        var a = t(e),
                            ...
                            o = { shortcodes: {}, windowWidth: t(window).width(), defaultText: a.get(0).lastChild.nodeValue, title: a.attr("title"), container: !!i.container && document.querySelector(i.container), text: function(e) { var s = JSON.parse(t(e).attr("data-hs-clipboard-options")); return o.shortcodes[s.contentTarget] } };
                        o = t.extend(!0, n, i, o, s), i.contentTarget && this.setShortcodes(a, o);
                        var r = new ClipboardJS(e, o);
                        return r.on("success", (function() {
                            (o.successText || o.successClass) && (o.successText && ("tooltip" === o.type ? (a.attr("data-original-title", o.successText).tooltip("show"), a.on("mouseleave", (function() { a.attr("data-original-title", o.title) }))) : "popover" === o.type ? (a.attr("data-original-title", o.successText).popover("show"), a.on("mouseleave", (function() { a.attr("data-original-title", o.title).popover("hide") }))) : (a.get(0).lastChild.nodeValue = " " + o.successText + " ", setTimeout((function() { a.get(0).lastChild.nodeValue = o.defaultText }), 800))), o.successClass && (o.classChangeTarget ? (t(o.classChangeTarget).removeClass(o.defaultClass).addClass(o.successClass), setTimeout((function() { t(o.classChangeTarget).removeClass(o.successClass).addClass(o.defaultClass) }), 800)) : (a.removeClass(o.defaultClass).addClass(o.successClass), setTimeout((function() { a.removeClass(o.successClass).addClass(o.defaultClass) }), 800))))
                        })), r
                    }
                },
        ...
        function(t) {
            t.HSCore.components.HSDatatables = {
                ...
                customPagination: function(e, s, a) { t("#" + a.pagination).append(t("#" + s.context[0].nTable.id + "_paginate")) },
                customSearch: function(e, s, a) { t(a.search).on("keyup", (function() { s.search(this.value).draw() })) },
                customColumnsSearch: function(e, s, a) {
                    var n = a;
                    s.columns().every((function() {
                        var e = this;
                        n.isColumnsSearchTheadAfter && t(".dataTables_scrollFoot").insertAfter(".dataTables_scrollHead"), t("input", this.footer()).on("keyup change", (function() { e.search() !== this.value && e.search(this.value).draw() })), t("select", this.footer()).on("change", (function() { e.search() !== this.value && e.search(this.value).draw() }))
                    }))
                },
                ...
                rowChecking: function(e) { t(e).on("change", "input", (function() { t(this).parents("tr").toggleClass("checked") })) },
                        ...
                        var a = t(e),
                            ...
                            o = {
                                init: function() {
                                    ...
                                    e.on("addedfile", (function(e) { "image/" !== String(e.type).slice(0, 6) && t(e.previewElement).find(".dz-img").replaceWith('<span class="dz-file-initials">' + e.name.substring(0, 1).toUpperCase() + "</span>"), s.hide() })), e.on("removedfile", (function() { e.files.length <= 0 && s.show() }))
                                }
                            };
                            ...
                            o = {
                                ...
                                afterShow: function(e) {
                                    var s = t(e.current.$slide),
                                        ...
                                        n = e.current.opts.$orig[0].dataset.hsFancyboxOptions ? JSON.parse(e.current.opts.$orig[0].dataset.hsFancyboxOptions) : {},
                                        i = !!n.transitionEffectCustom && n.transitionEffectCustom;
                                    i && (s.css("visibility", "visible"), s.hasClass("animated") || s.addClass("animated"), a && !a.hasClass("animated") && a.addClass("animated"), t("body").hasClass("fancybox-opened") ? (s.addClass(i.onShow), s.on("animationend webkitAnimationEnd oAnimationEnd MSAnimationEnd", (function(t) { s.removeClass(i.onShow) })), a && (a.addClass(i.onHide), a.on("animationend webkitAnimationEnd oAnimationEnd MSAnimationEnd", (function(t) { a.removeClass(i.onHide) })))) : (s.addClass(i.onShow), s.on("animationend webkitAnimationEnd oAnimationEnd MSAnimationEnd", (function(e) { s.removeClass(i.onShow), t("body").addClass("fancybox-opened") }))))
                                },
        ...
        function(t) {
            t.HSCore.components.HSFlatpickr = {
                defaults: { mode: "single", dateFormat: "d M Y", maxDate: !1, locale: { firstDayOfWeek: 1, weekdays: { shorthand: ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"] }, rangeSeparator: " - " }, nextArrow: '<i class="tio-chevron-right flatpickr-custom-arrow"></i>', prevArrow: '<i class="tio-chevron-left flatpickr-custom-arrow"></i>', disableMobile: !0 },
                init: function(e, s) {
                    if (e.length) {
                        var a = Object.assign({}, this.defaults),
            ...
            t.HSCore.components.HSIonRangeSlider = {
                ...
                init: function(e, s) {
                    if (e.length && void 0 !== e.attr("data-hs-ion-range-slider-options")) {
                            ...
                            i = {
                                onStart: function(e) {
                                    if (i.foreground_target_el) {
                                        ...
                                        t(i.foreground_target_el).css({ left: e.from_percent + "%", width: s + "%" }), t(i.foreground_target_el + " > *").css({ width: t(i.foreground_target_el).parent().width(), transform: "translateX(-" + e.from_percent + "%)" })
                                    }
                                    if (i.result_min_target_el && "single" === i.type ? t(i.result_min_target_el).is("input") ? t(i.result_min_target_el).val(e.from) : t(i.result_min_target_el).text(e.from) : (i.result_min_target_el || i.result_max_target_el && "double" === i.type) && (t(i.result_min_target_el).is("input") ? t(i.result_min_target_el).val(e.from) : t(i.result_min_target_el).text(e.from), t(i.result_min_target_el).is("input") ? t(i.result_max_target_el).val(e.to) : t(i.result_max_target_el).text(e.to)), i.grid && "single" === i.type && t(e.slider).find(".irs-grid-text").each((function(s) {
                                            var a = t(this);
                                            t(a).text() === e.from && (t(e.slider).find(".irs-grid-text").removeClass("current"), t(a).addClass("current"))
                                        })), i.secondary_target_el) { i.secondary_val.steps.push(e.max + 1), i.secondary_val.values.push(i.secondary_val.values[i.secondary_val.values.length - 1] + 1); for (var a = 0; a < i.secondary_val.steps.length; a++) e.from >= i.secondary_val.steps[a] && e.from < i.secondary_val.steps[a + 1] && (t(i.secondary_target_el).is("input") ? t(i.secondary_target_el).val(i.secondary_val.values[a]) : t(i.secondary_target_el).text(i.secondary_val.values[a])) }
                                },
                                onChange: function(e) {
                                    if (i.foreground_target_el) {
                                        var a = 100 - (e.from_percent + (100 - e.to_percent));
                                        t(i.foreground_target_el).css({ left: e.from_percent + "%", width: a + "%" }), t(i.foreground_target_el + "> *").css({ width: t(i.foreground_target_el).parent().width(), transform: "translateX(-" + e.from_percent + "%)" })
                                    }
                                    if (i.result_min_target_el && "single" === i.type ? t(i.result_min_target_el).is("input") ? t(i.result_min_target_el).val(e.from) : t(i.result_min_target_el).text(e.from) : (i.result_min_target_el || i.result_max_target_el && "double" === i.type) && (t(i.result_min_target_el).is("input") ? t(i.result_min_target_el).val(e.from) : t(i.result_min_target_el).text(e.from), t(i.result_min_target_el).is("input") ? t(i.result_max_target_el).val(e.to) : t(i.result_max_target_el).text(e.to)), i.grid && "single" === i.type && t(e.slider).find(".irs-grid-text").each((function(s) {
                                            var a = t(this);
                                            t(a).text() === e.from && (t(e.slider).find(".irs-grid-text").removeClass("current"), t(a).addClass("current"))
                        ...
                        return i.result_min_target_el && "single" === i.type && t(i.result_min_target_el).is("input") ? t(i.result_min_target_el).on("change", (function() { r.update({ from: t(this).val() }) })) : (i.result_min_target_el || i.result_max_target_el && "double" === i.type && t(i.result_min_target_el).is("input") || t(i.result_max_target_el).is("input")) && (t(i.result_min_target_el).on("change", (function() { r.update({ from: t(this).val() }) })), t(i.result_max_target_el).on("change", (function() { r.update({ to: t(this).val() }) }))), t(window).on("resize", (function() { t(i.foreground_target_el + " > *").css({ width: t(i.foreground_target_el).parent().width() }) })), o
                    }
                }
            }
        }(jQuery),
        ...
        function(t) {
            t.HSCore.components.HSLeaflet = {
                defaults: { map: { coords: [51.505, -.09], zoom: 13 }, layer: { token: "https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw", id: "mapbox/streets-v11", maxZoom: 18 }, marker: null },
                init: function(e, s) {
                    if (t(e).length) {
                        var a = t(e),
            ...
            t.HSCore.components.HSList = {
                ...
                init: function(e, s) {
                    if (t(e).length) {
                        ...
                        return r.searchMenu && t(l.list).fadeOut(0), l.on("searchComplete", (function() { r.searchMenu && (a.searchMenu(n, r, l), a.searchMenuHide(n, r, l)), !r.searchMenu && r.empty && a.emptyBlock(n, r, l) })), r.searchMenu && r.keyboard && a.initializeHover(n, r, l), l
                    }
                },
                ...
                searchMenuHide: function(e, s, a) {
                    ...
                    n.searchMenuOutsideClose && t(window).click((function() { t(i.list).fadeOut(n.searchMenuDelay), n.clearSearchInput && o.val("") })), n.searchMenuInsideClose || t(i.list).click((function(t) { t.stopPropagation(), n.clearSearchInput && o.val("") }))
                },
            ...
            t.HSCore.components.HSQuill = {
                ...
                toolbarBottom: function(e, s) {
                    if (s.toolbarBottom) {
                        ...
                        a.parent().addClass("ql-toolbar-bottom"), s.attach ? t(s.attach).on("shown.bs.modal", (function(t) { a.css({ paddingBottom: n.innerHeight() }) })) : a.css({ paddingBottom: n.innerHeight() }), n.css({ position: "absolute", width: "100%", bottom: 0 })
                    }
                }
            }
        }(jQuery),
        function(t) {
            t.HSCore.components.HSSelect2 = {
                ...
                init: function(e, s) {
                    if (e.length) {
                        var a = this,
                            ...
                            o = { templateResult: a.formatData, templateSelection: a.formatData, escapeMarkup: function(t) { return t } };
                        o = t.extend(!0, n, o, i, s);
                        var r = e.select2(o);
                        return e.siblings(".select2").find(".select2-selection").removeClass("select2-selection--single").addClass(o.customClass), o.singleMultiple && (a.singleMultiple(e, o), r.on("select2:select", (function(t) { a.singleMultiple(e, o) })), r.on("select2:unselect", (function(t) { a.singleMultiple(e, o) }))), a.safariAutoWidth(r, o), a.leftOffset(r, o), a.dropdownWidth(r, o), o.searchInputPlaceholder && a.searchPlaceholder(r, o), r
                    }
                },
                dropdownWidth: function(e, s) {
                    var a = s;
                    e.on("select2:open", (function() { t(".select2-container--open").last().css({ width: a.dropdownWidth }) }))
                },
                safariAutoWidth: function(e, s) { e.on("select2:open", (function() { t(".select2-container--open").css({ top: 0 }) })) },
                singleMultiple: function(e, s) {
                    ...
                    n.removeClass("select2-selection--multiple"), e.find(":selected").length > 0 ? n.addClass(a.singleMultipleActiveClass) : n.removeClass(a.singleMultipleActiveClass), n.find(".select2-selection__rendered").replaceWith('<span class="select2-selection__rendered" role="textbox" aria-readonly="true"><span class="select2-selection__placeholder">' + i + '</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>')
                },
                formatData: function(e) { var s, a = e; return a.element ? (s = a.element.dataset.optionTemplate ? a.element.dataset.optionTemplate : "<span>" + a.text + "</span>", t.parseHTML(s)) : a.text },
                leftOffset: function(e, s) {
                    var a = s;
                    e.on("select2:open", (function() {
                        if (a.leftOffset) {
                            let e = t(".select2-container--open").last();
                            e.css({ opacity: 0 }), setTimeout((function() { e.css({ left: parseInt(e.position().left) + a.leftOffset, opacity: 1 }) }), 1)
                        }
                    }))
                },
                searchPlaceholder: function(e, s) {
                    var a = s;
                    e.on("select2:open", (function() { t(".select2-container--open .select2-search__field").last().attr("placeholder", a.searchInputPlaceholder) }))
                }
            }
        }(jQuery),
        function(t) {
            t.HSCore.components.HSSlickCarousel = {
                ...
                init: function(e, s) {
                    if (e.length) {
                        var a = this,
                            ...
                            o = { id: e.attr("id") };
                        o = t.extend(n, o, i), o = t.extend(o, { customPaging: function(e, s) { var a = t(e.$slides[s]).data("hs-slick-carousel-slide-title"); return a && o.dotsWithIcon ? "<span>" + a + "</span>" + o.dotsWithIcon : o.dotsWithIcon ? "<span></span>" + o.dotsWithIcon : a && o.dotsFromTitles ? "<span>" + a + "</span>" : a && !o.dotsFromTitles ? '<span></span><strong class="dot-title">' + a + "</strong>" : "<span></span>" } }, s), e.find("[data-slide-type]").length && a.videoSupport(e), e.on("init", (function(t, s) { a.transformOff(e, o, t, s) })), e.on("init", (function(t, e) { a.setCustomAnimation(t, e) })), o.animationIn && o.animationOut && e.on("init", (function(t, e) { a.setSingleClass(t, e) })), o.dotsAsProgressLine && e.on("init", (function() { a.setCustomLineDots(e, o) })), o.hasDotsHelper && e.on("init", (function(t, e, s) { a.setCustomDots(t, e, s) })), o.isThumbs && (o.isThumbsProgressCircle && e.on("init", (function(t, s) { a.setCustomProgressCircle(e, o, t, s) })), t("#" + o.id).on("click", ".slick-slide", (function(e) { e.stopPropagation(), a.goToTargetSlide(t(this), o) }))), e.on("init", (function(t, s) { a.setCustomCurrentClass(e, t, s) })), e.on("init", (function(t, e) { a.setInitialCustomAnimation(t, e) })), o.counterSelector && e.on("init", (function(t, e) { a.setCounter(o, t, e) }));
                        var r = e.slick(o);
                        return t(o.asNavFor)[0] && t(o.asNavFor)[0].dataset.hsSlickCarouselOptions && JSON.parse(t(o.asNavFor)[0].dataset.hsSlickCarouselOptions).isThumbsProgress && a.setInitialDelay(e, o), e.on("beforeChange", (function(t, s, n, i) { a.setCustomClasses(e, t, s, n, i) })), o.counterSelector && e.on("beforeChange", (function(t, e, s, n) { a.counting(o, t, e, s, n) })), e.on("afterChange", (function(t, e) { a.setCustomAnimation(t, e) })), o.animationIn && o.animationOut && (e.on("afterChange", (function(t, e, s, n) { a.animationIn(o, t, e, s, n) })), e.on("beforeChange", (function(t, e, s) { a.animationOut(o, t, e, s) })), e.on("setPosition", (function(t, e) { a.setPosition(o, t, e) }))), r
                    }
                },
                ...
                setCustomAnimation: function(e, s) {
                    ...
                    t(n).each((function() {
                        ...
                        t(this).css({ "animation-delay": s + "ms", "animation-duration": a + "ms" }), t(this).addClass("animated " + e).css({ opacity: 1 })
                    }))
                },
                ...
                setSingleClass: function(e, s) { t(s.$slides).addClass("single-slide") },
                ...
                setCustomLineDots: function(e, s) {
                    var a = e.find('[class="' + s.dotsClass + '"]'),
                        n = a.find("li");
                    a.length && (setTimeout((function() { e.addClass("slick-line-dots-ready") })), n.each((function() { t(this).append('<span class="dot-line"><span class="dot-line-helper" style="transition-duration: ' + (s.autoplaySpeed + s.speed) + 'ms;"></span></span>') })))
                },
                setCustomProgressCircle: function(e, s, a, n) {
                    ...
                    })), r.text(".slick-thumb-progress .slick-thumb-progress__path {opacity: 0;fill: transparent;stroke: " + i.thumbsProgressOptions.color + ";stroke-width: " + i.thumbsProgressOptions.width + ";stroke-dashoffset: " + o + ";stroke-dashoffset: 0px;}.slick-current .slick-thumb-progress .slick-thumb-progress__path {opacity: 1;-webkit-animation: " + (n.options.autoplaySpeed + n.options.speed) + "ms linear 0ms forwards dash;-moz-animation: " + (n.options.autoplaySpeed + n.options.speed) + "ms linear 0ms forwards dash;-o-animation: " + (n.options.autoplaySpeed + n.options.speed) + "ms linear 0ms forwards dash;animation: " + (n.options.autoplaySpeed + n.options.speed) + "ms linear 0ms forwards dash;}@-webkit-keyframes dash {from {stroke-dasharray: 0 " + o + ";} to {stroke-dasharray: " + o + " " + o + ";}}@-moz-keyframes dash {from {stroke-dasharray: 0 " + o + ";} to {stroke-dasharray: " + o + " " + o + ";}}@-moz-keyframes dash {from {stroke-dasharray: 0 " + o + ";} to {stroke-dasharray: " + o + " " + o + ";}}@keyframes dash {from {stroke-dasharray: 0 " + o + ";} to {stroke-dasharray: " + o + " " + o + ";}}"), r.appendTo(e)
                },
                ...
                setCounter: function(e, s, a) {
                    var n = e;
                    t(n.counterSelector).html('<span class="' + n.counterClassMap.current + '">1</span><span class="' + n.counterClassMap.divider + '">' + n.counterDivider + '</span><span class="' + n.counterClassMap.total + '">' + a.slideCount + "</span>")
                },
                setInitialDelay: function(t, e) {
                    var s = e;
                    t.slick("slickPause"), setTimeout((function() { t.slick("slickPlay") }), s.initialDelay)
                },
                setCustomClasses: function(e, s, a, n, i) {
                    ...
                    })), t(c).each((function() { t(this).css({ opacity: 0 }) })), l.length && (n > i ? (t(l[0].children).removeClass("slick-active-right"), t(l[0].children[i]).addClass("slick-active-right")) : t(l[0].children).removeClass("slick-active-right"), t(l[0].children).removeClass("slick-current"), setTimeout((function() { t(l[0].children[i]).addClass("slick-current") }), .25))
                },
                ...
                videoSupport: function(e) {
                    e.length && e.on("beforeChange", (function(e, s, a, n) {
                        var i, o = t(s.$slides[a]).data("slide-type"),
            ...
            t.HSCore.components.HSTagify = {
                ...
                init: function(e, s) {
                    if (e.length) {
                        ...
                        return t(i.clearBtnSelector).on("click", o.removeAllTags.bind(o)), i.hasManualList && (this._renderSuggestionsList(e, o), e.on("add", (function() { 1 === o.suggestedListItems.length && t(o.DOM.dropdown).empty().fadeOut(0) })), e.on("remove", (function() { 0 === o.suggestedListItems.length && t(o.DOM.dropdown).fadeIn(0) }))), o
                    }
                },
                _renderSuggestionsList: function(t, e) { e.dropdown.show.call(e), t.parent()[0].appendChild(e.DOM.dropdown) }
            }
        }(jQuery),
        function(t) {
                ...
                init: function(e, s) {
                    if (e.length) {
                        var a = Object.assign({}, this.defaults),
                            ...
                            i = { errorPlacement: this.errorPlacement, highlight: this.highlight, unhighlight: this.unHighlight, submitHandler: this.submitHandler, onkeyup: function(e) { t(e).valid() } };
                        ...
                        var o = e.validate(i);
                        return e.find("select").length && e.find("select").change((function() { t(this).valid() })), o
                    }
                },
                rules: function(e) {
                    var s = Array.prototype.slice.call(arguments, 1);
